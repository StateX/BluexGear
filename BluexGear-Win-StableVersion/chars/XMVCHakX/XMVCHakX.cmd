...
[command]
name = "enma firefly camillia"
command = D,DF,F,a
time = 15

[command]
name = "unlimited counter"
command = F,D,DF,x
time = 15
;-| Double Tap |-----------------------------------------------------------
[Command]
...
;enma firefly camillia
[State -1, enma firefly camillia]
type = ChangeState
value = 1103
triggerall = command = "enma firefly camillia"
trigger1 = (statetype = s) && ctrl
trigger2=(stateno=[200,499]) && movecontact
...
type = Changestate
triggerall = stateno = 1103 && command = "y"
trigger1 = movecontact || time = [5,19]
value = 11031

[State -1,SLASH COMBO 2]
type = Changestate
triggerall = stateno = 11031 && command = "Hotaru"
trigger1 = movecontact || time = [5,19]
value = 11032
...
[State -1,SLASH COMBO 2]
type = Changestate
triggerall = stateno = 11032 && command = "Tsubaki"
trigger1 = movecontact || time = [5,19]
value = 11033


;unlimited mars
[State -1, unlimited mars]
type = ChangeState
value = 3500
triggerall = command = "unlimited mars"
trigger1 = (statetype = s) && ctrl
trigger2=(stateno=[200,499]) && movecontact
...
triggerall = power >= 1000
triggerall = command = "Final judgement"
triggerall = statetype != A
triggerall = ctrl
trigger1 = stateno != 100
;-------------------------------------------------------------------------------
...
triggerall = power >= 2000
triggerall = numhelper(26)
triggerall = command = "Final judgement1"
triggerall = statetype != A
triggerall = ctrl
trigger1 = stateno != 100
...
type = ChangeState
value = 3300
triggerall = command = "Akumetsu"
trigger1 = (statetype = s) && ctrl
trigger2=(stateno=[200,499]) && movecontact
triggerall = power >=3000

;Kouujin Shippu
[State -1, Kouujin Shippu]
type = ChangeState
value = 3000
triggerall = command = "Kouujin Shippu"
trigger1 = (statetype = s) && ctrl
trigger2=(stateno=[200,499]) && movecontact
triggerall = power >=1000
...
;unlimited counter
[State -1, unlimited counter]
type = ChangeState
value = 1006
triggerall = command = "unlimited counter"
trigger1 = (statetype = s) && ctrl
...
type = ChangeState
value = 1003
triggerall = command = "Kishuu"
trigger1 = (statetype = s) && ctrl
trigger2=(stateno=[200,499]) && movecontact

[State -1,SLASH COMBO 2]
type = Changestate
triggerall = stateno = 1003 && command = "y"
trigger1 = movecontact || time = [5,19]
value = 10031
