...
trigger1 = stateno = 420 && animelemtime(3) = 2
...
;fatal eruption
[State -1, fatal eruption]
type = ChangeState
value = 3000
triggerall = command = "fatal eruption"
trigger1 = (statetype = s) && ctrl
trigger1 = ctrl
trigger2=(stateno=[200,499]) && movecontact
triggerall = power >=1000
...
type = ChangeState
value = 1201
triggerall = numhelper(3794)=0
triggerall = var(28) = 0
trigger1 = command = "Furinkazan"
triggerall = power >=3000
...
;shuriken special
[State -1, shuriken special]
type = ChangeState
value = 3500
triggerall = command = "shuriken special"
triggerall = power >=1000
trigger1 = (statetype = a) && ctrl
trigger1 = ctrl
trigger2=(stateno=[600,650]) && movecontact
...
type = ChangeState
value = 1006
triggerall = command = "poison dart"
trigger1 = (statetype = a) && ctrl
trigger1 = ctrl
trigger2=(stateno=[600,650]) && movecontact
...
;void tempest
[State -1, void tempest]
type = ChangeState
value = 1203
triggerall = command = "void tempest"
trigger1 = (statetype = s) && ctrl
trigger1 = ctrl
trigger2=(stateno=[200,499]) && movecontact
...
;Heavenly pheonix
[State -1, Heavenly pheonix]
type = ChangeState
value = 1202
triggerall = command = "Heavenly pheonix"
trigger1 = (statetype = a) && ctrl
trigger1 = ctrl
trigger2=(stateno=[600,650]) && movecontact
...
;heavily rain
[State -1, heavily rain]
type = ChangeState
value = 1005
triggerall = command = "heavily rain"
trigger1 = (statetype = a) && ctrl
trigger1 = ctrl
trigger2=(stateno=[600,650]) && movecontact
...
type = ChangeState
value = 1200
triggerall = command = "pulvor fist"
trigger1 = (statetype = s) && ctrl
trigger1 = ctrl
trigger2=(stateno=[200,499]) && movecontact
...
type = ChangeState
value = 70010
triggerall = pos y > -1000
triggerall = var(28) > 0
triggerall = command != "upfwd"
triggerall = command != "upback"
trigger1 = command = "up"
