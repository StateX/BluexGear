...
triggerall = var(25) = 0
triggerall = power >= 1000
triggerall = command = "òAÇÀéOìrìnÇµ"
trigger1 = statetype != A
trigger1 = (ctrl||fvar(28)) || (StateNo = 5120 && animtime = 0)
trigger2 = var(3) = 0
trigger2 = (stateno = [200,451]) && (movecontact||movereversed)
...
triggerall = var(25) = 0
triggerall = var(40) < 2
triggerall = command = "àÍåÇïKéEèÄîı"
...
triggerall = var(58) = 2
triggerall = var(40) = 0
triggerall = command = "FBîõ" || (helper(780+id),var(5)&&command = "z")
triggerall = power >= 500
trigger1 = Stateno = [150,153]
trigger1 = (anim = [120,155])||anim = 1201
...
triggerall = !ishelper
triggerall = var(59) <= 0
triggerall = command = "ódéhêw" || (helper(780+id),var(5)&&command = "x")
triggerall = var(58) != 1
trigger1 = Stateno = [150,153]
trigger1 = (anim = [120,155])||anim = 1201
...
triggerall = !ishelper
triggerall = var(59) <= 0
triggerall = command = "âÒÇËçûÇ›" || (helper(780+id),var(5)&&command = "a")
triggerall = var(58) != 1
trigger1 = Stateno = [150,153]
trigger1 = (anim = [120,155])||anim = 1201
...
triggerall = !ishelper
triggerall = var(59) <= 0
triggerall = command = "óÙóÖ" || (helper(780+id),var(5)&&command = "y")
triggerall = var(58) != 1
trigger1 = Stateno = [150,153]
trigger1 = (anim = [120,155])||anim = 1201
...
triggerall = var(59) <= 0
triggerall = var(58) = 2
triggerall = command = "óWó˘" || (helper(780+id),var(5)&&command = "b")
trigger1 = Stateno = [150,153]
trigger1 = (anim = [120,155])||anim = 1201
...
[State -1]
type = ChangeState
value = 1300 + (var(58)=1)*10
triggerall = !ishelper
triggerall = var(59) <= 0
triggerall = command = "ódéaêÓ"
trigger1 = statetype = A
trigger1 = (ctrl||fvar(28))
trigger2 = (stateno = [600,630]) && (movecontact||movereversed) && var(3) = 0
...
trigger1 = (stateno = [220, 225]) && (movecontact||movereversed||fvar(28))
trigger2 = stateno = 206 && (movecontact||movereversed||fvar(28))
trigger3 = stateno = 200 && (movecontact||movereversed||fvar(28))
trigger4 = stateno = 210 && (movecontact||movereversed||fvar(28))
trigger5 = stateno = 450 && (movecontact||movereversed||fvar(28))
trigger6 = stateno = 235 && (movecontact||movereversed||fvar(28))
trigger7 = stateno = 700 && (movecontact||movereversed||fvar(28)) && animelemtime(6) >= 0
...
triggerall = p2bodydist X = [-22,22 - (var(58)=2)*2]
triggerall = p2statetype != A
...
trigger5 = var(29)
trigger5 = stateno = 220||stateno = 235
...
triggerall = var(3) = 0
trigger1 = stateno = 200||stateno = 210||stateno = 220||stateno = 225
trigger1 = (movecontact||movereversed)
...
triggerall = command = "y"
triggerall = var(3) = 0
trigger1 = p2bodydist X > 44 || p2bodydist X < -44
trigger1 = stateno = 200||stateno = 210
trigger1 = (movecontact||movereversed)
trigger2 = p2bodydist X > 44 || p2bodydist X < -44
...
trigger4 = time > ifelse((anim=196||anim=198),18,64)
...
trigger4 = stateno = 210 && (movecontact||movereversed||fvar(28))
trigger5 = stateno = 450 && (movecontact||movereversed||fvar(28))
trigger6 = stateno = 235 && (movecontact||movereversed||fvar(28)) && var(58) != 1
trigger7 = stateno = 700 && (movecontact||movereversed||fvar(28)) && animelemtime(6) >= 0
