...
[command]
name = "Crownish Calendula 2"
command = a,y
time = 15

[command]
name = "Crownish Calendula"
command = a,z
time = 15
...
triggerall = command = "Blood_Kain1"
triggerall = statetype != A
trigger1 = (statetype = s) && ctrl
trigger1 = ctrl
trigger2=(stateno=[200,499]) && movecontact
...
;Crownish Calendula 2
[State -1, Crownish Calendula 2]
type = ChangeState
value = 3500
triggerall = command = "Crownish Calendula 2"
trigger1 = (statetype = s) && ctrl
trigger1 = ctrl
trigger2=(stateno=[200,499]) && movecontact
...
;unlimited thunder
[State -1, unlimited thunder]
type = ChangeState
value = 1400
triggerall = command = "unlimited thunder"
...
type = ChangeState
value = 1400
triggerall = numhelper(1030)=0 && random <=100
triggerall = power >=1000
triggerall = var(59)>=1
triggerall = statetype != A
trigger1 = stateno = 210 && movehit && p2statetype !=A
...
type = ChangeState
value = 3600
triggerall = numhelper(3061)=0 && random <=100
triggerall = power >=2000
triggerall = var(59)>=1
triggerall = statetype != A
trigger1 = stateno = 210 && movehit && p2statetype !=A
...
;Crownish Calendula
[State -1, Crownish Calendula]
type = ChangeState
value = 2800
triggerall = command = "Crownish Calendula"
trigger1 = (statetype = s) && ctrl
trigger1 = ctrl
trigger2=(stateno=[200,499]) && movecontact
triggerall = power >=3000
...
;Baden Baden lily
[State -1, Baden Baden lily]
type = ChangeState
value = 2502
triggerall = command = "Baden Baden lily 2"
trigger1 = (statetype = s) && ctrl
trigger1 = ctrl
trigger2=(stateno=[200,499]) && movecontact
triggerall = power >=1000
...
type = ChangeState
value = 1000
triggerall = numhelper(1021) = 0 && random <=100
triggerall = var(59)>=1
triggerall = statetype != A
trigger1 = stateno = 210 && movehit && p2statetype !=A
trigger2 = (p2bodydist x >= 100) && (random <=100) && ctrl
...
type = ChangeState
value = 1001
triggerall = numhelper(1023) = 0 && random <=100
triggerall = var(59)>=1
triggerall = statetype != A
trigger1 = stateno = 210 && movehit && p2statetype !=A
trigger2 = (p2bodydist x >= 100) && (random <=100) && ctrl
...
type = ChangeState
value = 1002
triggerall = numhelper(1024) = 0 && random <=100
triggerall = var(59)>=1
triggerall = statetype != A
trigger1 = stateno = 210 && movehit && p2statetype !=A
trigger2 = (p2bodydist x >= 100) && (random <=100) && ctrl
