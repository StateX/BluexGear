...
;===============================================================================
[State -1, AI Step Kick]
type = ChangeState
value = 215
triggerall = var(59)>0 && roundstate = 2
triggerall = statetype = S
trigger1 = ctrl && P2Movetype != H && P2Dist x < 50 && Random > 970
...
triggerall = roundstate = 2
triggerall = statetype != A
trigger1 = stateno = 200 && animtime = 0 && movehit > 0
...
;Muzzle drive
[State -1, Muzzle drive]
type = ChangeState
value = 1002
triggerall = command = "Muzzle drive"
trigger1 = (statetype = s) && ctrl
trigger2=(stateno=[200,499]) && movecontact


;optic barrel
[State -1, optic barrel]
type = ChangeState
value = 1000
triggerall = command = "optic barrel"
trigger1 = (statetype = s) && ctrl
trigger1 = ctrl
trigger2=(stateno=[200,499]) && movecontact
...
type = ChangeState
value = 1001
triggerall = command = "driver combo"
trigger1 = (statetype = s) && ctrl
trigger1 = ctrl
trigger2=(stateno=[200,499]) && movecontact
...
type = ChangeState
value = 1005
triggerall = command = "Spring_Raid"
trigger1 = (statetype = a) && ctrl
trigger1 = ctrl
...
type = ChangeState
value = 1006
triggerall = command = "gun shot air"
trigger1 = (statetype = a) && ctrl
trigger1 = ctrl
trigger2=(stateno=[600,650]) && movecontact
...
;H.Body crush
[State -1, H.Body crush]
type = ChangeState
value = 3200
triggerall = command = "H.Body crush"
trigger1 = (statetype = s) && ctrl
trigger2=(stateno=[200,499]) && movecontact
triggerall = power >= 1000
